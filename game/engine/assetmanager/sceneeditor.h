#ifndef GP_FRAMEWORK_SCENEEDITOR_H
#define GP_FRAMEWORK_SCENEEDITOR_H
...
namespace Engine {
    ...
    class SceneEditor : public ImGuiWindowBaseClass {
    public:

        SceneEditor(bool visible);
    ...
    private:
        ...
        // State
        ImVector<SelectableField> Items;               // Our items
